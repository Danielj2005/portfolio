      ...
      <SectionWithTitle
        ...
        title="Dominio Tecnológico">
          ...
          <Card 
            ...
            cardClass="bg-slate-800 p-6 rounded-xl border border-blue-500/20 hover:shadow-2xl hover:shadow-blue-500/10 transition hover:scale-105" >
          ...
          <Card 
            ...
            cardClass="bg-slate-800 p-6 rounded-xl border border-yellow-500/20 hover:shadow-2xl hover:shadow-yellow-500/10 transition hover:scale-105 transition shadow-yellow-500/5">
          ...
          <Card 
            ...
            cardClass="bg-slate-800 p-6 rounded-xl border border-emerald-500/20 hover:shadow-2xl hover:shadow-emerald-500/10 transition animation: hover:scale-105">
